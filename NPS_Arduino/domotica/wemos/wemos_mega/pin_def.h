...
//------------------------------
#define USE_SPI_SHIFT_REG
#ifdef USE_SPI_SHIFT_REG
  #define PIN_SHIFT_REG_LATCH 45
  #define PIN_SHIFT_REG_DATA  51
  #define PIN_SHIFT_REG_CLK   52
#else
  #define PIN_SHIFT_REG_LATCH 25
  #define PIN_SHIFT_REG_DATA  23
  #define PIN_SHIFT_REG_CLK   27
#endif
//----Adafruit -----------------
#define TFT_CS        48
...
//------------------------------
// se il pin da utilizzare ̬ minore di OFFS_MPX_1 allora ci si riferisce all'arduino,
...
//------------------------------
// come sopra ma per gli shift register, ne serve uno blocco solo perch̩ possono essere messi in cascata
...
//------------------------------
#define MPLEX_1_EN  0
#define MPLEX_1_S1  O_SR_3(0)
#define MPLEX_1_S2  O_SR_3(1)
#define MPLEX_1_S3  O_SR_3(2)
#define MPLEX_1_S4  O_SR_3(3)
#define MPLEX_1_Z   30

#define MPLEX_2_EN  0
#define MPLEX_2_S1  O_SR_3(4)
#define MPLEX_2_S2  O_SR_3(5)
#define MPLEX_2_S3  O_SR_3(6)
#define MPLEX_2_S4  O_SR_3(7)
#define MPLEX_2_Z   31

#define MPLEX_3_EN  0
#define MPLEX_3_S1  O_SR_4(0)
#define MPLEX_3_S2  O_SR_4(1)
#define MPLEX_3_S3  O_SR_4(2)
#define MPLEX_3_S4  O_SR_4(3)
#define MPLEX_3_Z   7
//------------------------------
#endif
//------------------------------
